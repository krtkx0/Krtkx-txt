...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/KRTKx")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/KRTKx"), InlineKeyboardButton(text="🛠️ JOIN", url="https://t.me/BotsByKk")],
    ]
)
